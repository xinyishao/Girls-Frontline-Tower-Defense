...
public class Type561 extends Tower {
    ...
    private double skillDamage = 150;
    ...
    public Type561() {
        super("type561", 150, 2, 14, 6, 700, 150);
    }
    ...
    public void decreaseSkillDamage(double num) {
        skillDamage = (skillDamage - num > 0) ? skillDamage - num : 0;
    }
}
